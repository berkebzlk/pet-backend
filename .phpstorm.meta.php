...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Modules\Role\Repositories\RoleRepositoryInterface' => \App\Modules\Role\Repositories\Impl\RoleRepository::class,
            'App\Modules\Role\Services\RoleServiceInterface' => \App\Modules\Role\Services\Impl\RoleService::class,
            'App\Modules\User\Repositories\UserRepositoryInterface' => \App\Modules\User\Repositories\Impl\UserRepositoryEloquent::class,
            'App\Modules\User\Services\UserServiceInterface' => \App\Modules\User\Services\Impl\UserService::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/berke/dev/php/laravel/laravel12-boilerplate/public/storage' => 'string',
            ...
            'ide-helper.interfaces.App\Modules\Core\Repositories\BaseRepositoryInterface' => 'string',
            'ide-helper.interfaces.App\Modules\Core\Services\BaseServiceInterface' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./home/berke/dev/php/laravel/laravel12-boilerplate/public/storage','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'ide-helper.interfaces.App\\Modules\\Core\\Repositories\\BaseRepositoryInterface','ide-helper.interfaces.App\\Modules\\Core\\Services\\BaseServiceInterface','ide-helper.model_camel_case_properties','ide-helper.type_overrides.integer','ide-helper.type_overrides.boolean',
...
'passport.guard','passport.private_key','passport.public_key','passport.connection','permission.models.permission',
...
'crud.created','crud.updated','crud.deleted','http.200','http.201',
'http.204','http.400','http.401','http.403','http.404',
'http.405','http.422','http.500','http.503','http.504',
'models.Spatie\\Permission\\Models\\Role','models.App\\Modules\\User\\Models\\User','status.0','status.1','status.2',
'status.3','validation.max','validation.min','validation.invalid','validation.attributes.id',
'validation.attributes.name','validation.attributes.email','validation.attributes.password','validation.attributes.password_confirmation','validation.attributes.role',
'validation.attributes.permissions','validation.attributes.title','validation.attributes.content','validation.attributes.image','validation.attributes.status',
'validation.attributes.created_at','validation.attributes.updated_at','validation.attributes.deleted_at','role::role.created_successfully','role::role.updated_successfully',
'role::role.deleted_successfully','role::role.not_found','role::role.name_already_exists','role::role.assigned_successfully','role::role.removed_successfully',);
